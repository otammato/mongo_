...
Verify your app's connection using your web browser. Enter the Terraform output, either the DNS address or the public IP of the created EC2 instance, in the browser's address bar.
